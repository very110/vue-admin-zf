<template>
    <el-form :inline="true">
        ...
        <el-form-item label="三级分类">
            <el-select v-model="categoryStore.c3Id" class="m-2" :disabled="scene!=0" placeholder="请选择" @change="handler3">
                <el-option
...
const handler3=()=>{
    emit('changeC3Id',[categoryStore.c1Id,categoryStore.c2Id,categoryStore.c3Id])
}
</script>
